...
const findKey = function(obj, callback) {
  for (let key of Object.keys(obj)) {//use Object.keys() to search through all the object keys
    if (callback(obj[key])) {//find the first key that the callback looks for
